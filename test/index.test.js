...
(() => {
  ...
  should('sol: sys/transfer (2**53-1)', () => {
    const opt = {
      source: 'DV8e8SwcZEaPEGDsLEh3HmXySxbMGaC2TSVCh2Pz6UF1',
      destination: '6y6nyKZKU3kuhSHdGT9YQ63DSj2tWoqKB8xui2cofqqj',
      lamports: 2 ** 53 - 1,
  ...
  should('sol: sys/transfer (2**54-1)', () => {
  ...
  should('sol: sys/transferWithSeed', () => {
    const opt = {
  ...
  should('sol: sys/allocateWithSeed', () => {
    const opt = {
  ...
  should('sol: sys/createAccountWithSeed', () => {
    const opt = {
  ...
  should('sol: sys/initializeNonce', () => {
    const opt = {
  ...
  should('sol: sys/withdrawFromNonce', () => {
    const opt = {
  ...
  should('sol/token: initializeMint', () => {
  ...
  should('sol/token: initializeMint (optional)', () => {
    const t = sol.token.initializeMint({
      mint: '7o36UsWR1JQLpZ9PE2gn9L4SQ69CNNiWAXd4Jt7rqz9Z',
      decimals: 2,
      mintAuthority: 'DShWnroshVbeUp28oopA3Pu7oFPDBtC1DBmPECXXAQ9n',
  ...
  should('sol/token: initializeAccount', () => {
  ...
  should('sol/token: transfer (2**53-1)', () => {
    const t = sol.token.transfer({
      source: '7o36UsWR1JQLpZ9PE2gn9L4SQ69CNNiWAXd4Jt7rqz9Z',
      destination: 'DShWnroshVbeUp28oopA3Pu7oFPDBtC1DBmPECXXAQ9n',
      owner: 'Hozo7TadHq6PMMiGLGNvgk79Hvj5VTAM7Ny2bamQ2m8q',
  ...
  should('sol/token: setAuthority (new)', () => {
  ...
  should('sol/token: freezeAccount', () => {
  ...
  should('sol/token: transferChecked', () => {
  ...
  should('sol/token: approveChecked', () => {
  ...
  should('sol/token: mintToChecked', () => {
  ...
  should('sol/token: syncNative', () => {
    const t = sol.token.syncNative({
      nativeAccount: '7o36UsWR1JQLpZ9PE2gn9L4SQ69CNNiWAXd4Jt7rqz9Z',
    });
    deepStrictEqual(t, {
      program: 'TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA',
      keys: [{ address: '7o36UsWR1JQLpZ9PE2gn9L4SQ69CNNiWAXd4Jt7rqz9Z', sign: false, write: true }],
      data: hex.decode('11'),
    });
  });

  should('sol: associatedToken', () => {
